...
using QuinelaWeb.Sessions;
using QuinelaWeb.Web.Controllers.Results;
using QuinelaWeb.Web.Models;
using QuinelaWeb.Web.Models.Account;
...
{
    public class AccountController : QuinelaWebControllerBase
    {
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                vUsuarioDto.Clave = model.Password;
                vUsuarioDto.Correo = model.EmailAddress;
                vUsuarioDto.Invitado = false;
        ...
        private ActionResult RecoverPassword()
        {
            ViewBag.IsMultiTenancyEnabled = _multiTenancyConfig.IsEnabled;
        ...
        [HttpPost]
        public virtual async Task<ActionResult> RecoverPassword(RecoverPasswordModel model)
        {
            try
            {
                ...
                string  vPassword = new PasswordHasher().HashPassword(Authorization.Users.User.CreateRandomPassword());
                var result = await _userManager.ResetPasswordAsync(user.Id, token, vPassword);
