...
namespace QuinelaWeb.Users
{
    ...
    public class UserAppService : AsyncCrudAppService<User, UserDto, long, PagedResultRequestDto, CreateUserDto, UpdateUserDto>, IUserAppService
    {
        ...
        public UserAppService(
            ...
            RoleManager roleManager, IUsuarioManager InitUsuarioManager)
            : base(repository)
        {
        ...
        public override async Task<UserDto> Create(CreateUserDto input)
        {
            ...
            long ? vId  = AbpSession.UserId;
            var users = _userManager.Users.Where(u => u.Id == vId).ToList().FirstOrDefault();
            Usuario vRecord = new Usuario();
            vRecord.Clave = input.Password;
            vRecord.Correo = input.EmailAddress;
            vRecord.CreatorUserId = AbpSession.UserId;
            vRecord.CorreoAnfitrion = users.EmailAddress;
